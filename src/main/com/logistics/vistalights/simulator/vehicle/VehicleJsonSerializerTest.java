...
public class VehicleJsonSerializerTest {
	class MockupVehicle implements Vehicle {
		...
		public CargoContainer getCargoContainer() {
			return new CargoContainer(100, 
					LocalDateTime.of(2015, 1, 20, 10, 10, 10));
		}
		...
		/* (non-Javadoc)
		 * @see com.logistics.simulator.vehicle.Vehicle#setSchedule(com.logistics.simulator.vehicle.scheduler.Schedule)
		 */
		@Override
	...
	/**
	 * Test method for {@link com.logistics.simulator.vehicle.VehicleJsonSerializer#toString(com.logistics.simulator.vehicle.Vehicle)}.
	 */
	@Test
	public void testToStringVehicle() {
		VehicleJsonSerializer serializer = new VehicleJsonSerializer();
		Vehicle vehicle = new MockupVehicle();
		String json = serializer.toString(vehicle);
		assertEquals(
			"{"
			+ "\"vehicle_id\":1,"
